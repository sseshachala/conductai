...
def upgrade() -> None:
    ...
    # CONCURRENTLY so the drop doesn't take an ACCESS EXCLUSIVE lock on
    # projects for the duration of the index removal (mirrors 0087's
    # create-CONCURRENTLY that added the index).
    op.execute(
