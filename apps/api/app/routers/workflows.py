...
_PLAYBOOK_META = {
    ...
    "security_loop":              {"icon": "🔐",  "category": "Security",    "tags": ["security", "agentic", "autopilot"],                "featured": True,  "description": "Security Loop Automation — AI agent triages every finding from Security Loop for Claude. Dismisses false positives instantly, escalates real threats, and with Agentic Autopilot opens fix PRs autonomously."},
    "security_autopilot_fix":     {"icon": "🔧",  "category": "Security",    "tags": ["security", "github", "autopilot"],                 "featured": True,  "description": "Security finding → reads affected file → writes targeted patch → opens PR → notifies Slack. Triggered from the Security Loop activity page."},
