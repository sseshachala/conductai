    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="px-6 py-5 flex items-center justify-between max-w-6xl mx-auto w-full">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-stone-900 text-base tracking-tight">Delegators</span>
        </div>
        {isLoaded && (
          isSignedIn ? (
            <button
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 pt-16 pb-24 text-center">
        ...
        <p className="mt-6 text-xl text-stone-500 max-w-2xl leading-relaxed">
          Delegators ships with 9 ready-made agents — label a GitHub issue, get a PR.
      ...
      {/* Why Delegators — the moat */}
      <section className="px-6 py-20">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-semibold text-stone-400 uppercase tracking-widest text-center mb-3">Why Delegators</p>
      ...
      <section className="px-6 py-20 text-center">
        ...
        <p className="text-stone-500 mb-8 max-w-md mx-auto">
          {isLoaded && isSignedIn
            ...
            : "Sign in with Google, connect your GitHub repo, and let Delegators pick up its first ticket."}
        </p>
        {isLoaded && (
          isSignedIn ? (
            <button
      ...
      <footer className="border-t border-stone-100 py-8 text-center text-xs text-stone-400">
        © {new Date().getFullYear()} Delegators · Built for engineering teams
      </footer>
    </div>
  )
}
...
const HOW_IT_WORKS = [
  {
    ...
    body: "Link GitHub, Slack, and Linear in five minutes. No migration, no new workflow — Delegators fits around what you already use.",
  },
  {
    title: "Delegators picks up the work",
    body: "Label an issue `ai-ready` or fire a webhook. Delegators spins up an ephemeral sandbox, clones your repo, implements the fix, and runs your tests.",
  },
  {
...
const WHY_DELEGATOR = [
  ...
  },
  {
    ...
    body: "GitHub, Slack, PagerDuty, OpsGenie, email, and any inbound webhook. No new tools, no migration — Delegators plugs into what your team already uses.",
  },
]
