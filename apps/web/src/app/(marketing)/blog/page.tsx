export default function BlogIndex() {
  const posts = [
    ...
    {
      slug: "threat-modeling-is-a-playbook",
      title: "Threat modeling is a playbook, not a product.",
      excerpt: "The security industry has spent twenty years selling threat modeling as a workshop, a tool category, a compliance checkbox. It's none of those things. It's a task the AI in your PR flow can do on every merge.",
      date: "July 25, 2026",
      tag: "Security",
