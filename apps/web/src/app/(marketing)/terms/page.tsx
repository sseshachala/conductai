      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone prose-sm max-w-none space-y-6 text-stone-600 leading-relaxed">
          ...
          <section>
            ...
            <p>The Conduct codebase is available under the Conduct AI License (free for individuals, commercial license for companies) at <a href="https://github.com/sseshachala/conduct-cli" target="_blank" rel="noopener noreferrer" className="text-stone-900 underline hover:no-underline">github.com/sseshachala/conduct-cli</a>. Self-hosted deployments are your responsibility.</p>
          </section>
          <section>
