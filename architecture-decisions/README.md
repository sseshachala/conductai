...
Key architectural decisions for ConductAI. Each record explains what was decided, why, and what alternatives were rejected.

| ACD | Decision | Status |
|-----|----------|--------|
| [ACD-0001](ACD-0001-three-surface-interception.md) | Three-surface policy interception | Accepted |
