...
| 13 | RUNBOOK.md + QUICKSTART.md split | SHIPPED | `docs/modules/conductguard/QUICKSTART.md` (dev-side, 15-min path) + `docs/modules/conductguard/RUNBOOK.md` (ops-side, on-call playbook with health checks, failure modes, rollback, alert map). Cross-linked from `README.md`. Shipped in #1147 |
